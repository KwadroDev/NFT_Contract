...
contract LittleHorse is ERC721Enumerable, Ownable {  
    ...
    string public baseTokenURI = "http://159.65.232.27/";
    ...
    constructor () ERC721 ("Little Horse V2", "LILHv") {
        price = initial_price;
    }
    ...
    function mintWhitelist(uint256 _amount) public payable {
        ...
        require( msg.value == price * _amount,      "Wrong amount of WETH sent" );
